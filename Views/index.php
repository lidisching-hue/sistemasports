                            ...
                            <div class="col-lg-4">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header bg-info">
                                        <h4 class="text-center font-weight-light my-4 text-white">INICIAR SESIÓN</h4></div>
                                    <div class="card-body">
                                        <form id="frmLogin">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-center class mt-4 mb-0">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted"> Creado por Jessy 2026 &copy;</div>
                            <div>
